---
title: Enhanced Kairo Core Functions
description: Comprehensive reference for Kairo's core functions, designed for high flexibility and functionality.
---

# Kairo Core Functions

The `core` functions in Kairo are lightweight yet powerful utilities always available in every Kairo file. They're designed to support foundational tasks, system interactions, and low-level functionality, with an eye toward a versatile, Rust/Zig-inspired future.
