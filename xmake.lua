...
local function print_all_info(target)
    ...
    then
        ...
        print(yellow .. "#                                                                  #")
        print(yellow .. "#  " .. reset .. "Kairo is licensed under the " .. magenta .. "Apache License 2.0 with the" .. yellow .. "     #")
        print(yellow .. "#  " .. magenta .. "Kairo Runtime Library Exception." .. yellow .. "                                #")
        print(yellow .. "#                                                                  #")
        print(yellow .. "#  " .. reset .. "This means you're free to use, modify, and distribute Kairo," .. yellow .. "    #")
        print(yellow .. "#  " .. reset .. "including for commercial purposes, subject to the terms of the" .. yellow .. "  #")
        print(yellow .. "#  " .. reset .. "license. The runtime exception permits linking compiled output" .. yellow .. "  #")
        print(yellow .. "#  " .. reset .. "without imposing license requirements on user code." .. yellow .. "             #")
        print(yellow .. "#  " .. cyan .. "https://www.kairolang.org/LICENSE.txt" .. yellow .. "                           #")
        print(yellow .. "#                                                                  #")
        print(yellow .. "#  " .. magenta .. "SPDX-License-Identifier: " .. reset .. "Apache-2.0 WITH KAIRO-RUNTIME-EXCEPTION" .. yellow .. " #")
        print(yellow .. "#  " .. reset .. "Copyright (c) 2026 " .. cyan .. "Dhruvan Kartik" .. yellow .. "                               #")
        print(yellow .. "#                                                                  #")
        print(yellow .. "#===------------------------------------------------------------===#" .. reset)
