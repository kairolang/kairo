...
print("    --> " + white + " file " + light_green + "tests/main.k" + white + ":" + yellow + "1" + white + ":" + yellow + "4" + reset)
...
print("       --> " + white + " file " + light_green + "tests/main.k" + white + ":" + yellow + "4" + white + ":" + yellow + "4" + reset)
